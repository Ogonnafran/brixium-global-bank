      ...
      <div className="px-6">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-blue-500/10 rounded-xl p-4 border border-blue-500/20">
              <p className="text-blue-400 text-sm">
                ℹ️ You can receive money from another Brixium user using your Account ID. 
                Internal transfers are free and instant between Brixium users.
              </p>
            </div>
          </div>
        )}
        ...
        {activeTab === 'crypto' && (
          <div className="space-y-4">
            ...
            <div className="bg-blue-500/10 rounded-xl p-4 border border-blue-500/20">
              <p className="text-blue-400 text-sm">
                ℹ️ You can receive crypto to any of the wallet addresses above. Each address is unique to your account and secure.
              </p>
            </div>
          </div>
        )}
